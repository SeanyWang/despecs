...
\begin{clarification}
Make sure that for each §<p>§ there is a corresponding §</p>§ somewhere.
...
\bold{</fig>} \\
\bold{<p it>_}THEON\bold{_} ex Zãb. Areola nãq; α β, \\
\bold{<fig>}\\
\bold{<var>}α @ @ ζ @ γ @ @ @ @\bold{</var>} \\
\bold{</fig>} \\
cõpreh\bs\tld{}edatur $ub ratiõali α γ, \& 2 a- \\
...
\bold{<desc>}Pourpre\bold{</desc>} \\
\bold{<desc>}Bleu\bold{</desc>} \\
\bold{<desc>}Verd\bold{</desc>} \\
\bold{<desc>}Jaune\bold{</desc>} \\
\bold{<desc>}Orange\bold{</desc>} \\
\bold{<desc>}Rouge\bold{</desc>} \\
...
tionibus, accuratí$que $choli\li{is} illu$trati: nunc quartò editi, \\
...
ausgemacht, daß das leitende Vermögen der Körter eini- \\
