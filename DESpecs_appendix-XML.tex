...
\bold{<lb/>}pãſio eſt ſuper ſuperficies,\bold{<unclear/>} applicatio´\xent{que} nõ directa. 9 Quãdo autem \\
\bold{<lb/>}angul\bs\tld{}u continent duæ lineæ rect\xent{ae}, rectilineus angulus nominatur. \\
\bold{<lb/>}10 Quãdo recta linea ſuper rectã ſteterit, duo´\xent{que} anguli utrobi\xent{que} fue \\
\bold{<lb/>}rint \xent{ae}quales, eor\bs\tld{}u uter\xent{que} rectus erit, linea´\xent{que} lineæ ſuperſtãs,\lwr ei cui ſu- \\
\bold{<lb/>}perſtat, perp\bs\tld{}edicularis uoca\xent{tur}. 11 Angulus uerò qui recto maior eſt, \\
...
\bold{</figure>}\\
\bold{<p>}\bold{<lb/>}13 Terminus eſt, \xent{quo}d uniuſcuiuſ\xent{que} finis eſt. 14 Figura eſt, quæ termi \\
