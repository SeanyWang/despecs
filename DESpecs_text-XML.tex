...
\begin{note}
Headings (\sect{section headings}) are marked by \xmlpair{h} instead of §<p>§~§</p>§. Block quotations  (\sect{section block quotations}) are marked by §<q>§~§</q>§ instead of §<p>§~§</p>§. The §<p>§ and §</p>§ tags should not be used in marginal notes (\sect{section marginal notes}) or footnotes (\sect{section footnotes}).
\end{note}
