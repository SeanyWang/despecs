...
\begin{note}
Headings (\sect{section headings}) are marked by \xmlpair{h} instead of \xmlpair{p}. Block quotations  (\sect{section block quotations}) are marked by \xmlpair{quote} instead of \xmlpair{p}. The \xmlpair{p} tags should not be used in marginal notes (\sect{section marginal notes}) or footnotes (\sect{section footnotes}).
\end{note}
...
\bold{<quote>}Et ſi (modo credimus) vnum\\
...
\bold{<quote>}Nitor in aduerſum, nec me, qui cætera vincit.\\
