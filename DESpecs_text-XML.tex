...
\bold{<p>}Secunda cauſa eſt, quia quoduis graue corpus, aut per naturam, aut per vim mo-\bold{<lb/>} \\
tum, rectitudinem itineris naturaliter appetat, quod clarè cognoſcere poſſumus,\bold{<lb/>} \\
proijciendo lapides funda, &amp; circunducentes brachium, nam funes tanto maius\bold{<lb/>} \\
pondus acquirunt, &amp; manum tanto magis onerant, quanto velocius voluitur funda,\bold{<lb/>} \\
&amp; incitatur motus, quod ab appetitu naturali inſito ei corpori per lineã rectam\lwr pro-\bold{<lb/>} \\
grediendi procedit. Vnde fit, vt pondus circunferentiæ ipſius rotæ, tanto facilius\lwr cir-\bold{<lb/>} \\
cunuoluatur, &amp; ex ſeipſo tanto longiori tempore moueatur, quanto longius diſtat\lwr  à\bold{<lb/>} \\
centro, cum eius iter tanto minus ſit curuum. Hanc igitur ob cauſam, rota, quanto\bold{<lb/>} \\
maior erit, eiuſ\bs´q; pondus tanto magis vicinum circunferentiæ, tanto magis\lwr durabit\bold{<lb/>} \\
...
\bold{<quote>}Et ſi (modo credimus) vnum\bold{<lb/>} \\
Iſſe diem ſine Sole ferunt, incendia lumen\bold{<lb/>} \\
Præbebant.\bold{</quote>}\\
\bold{<p>}Quod autem à Patre inſtruatur etiam de curſu annuali,\bold{<lb/>} \\
videbitur vbi ita dicit.\bold{</p>}\\
\bold{<quote>}Nitor in aduerſum, nec me, qui cætera vincit.\bold{<lb/>} \\
Impetus, &amp; rapido contrarius euehor orbi.\bold{</quote>} \\
...
\begin{typeLatin}
\bold{<p>} \someText \\
quem quidem tractatum cum quibuſdam alijs meis ſpeculationibus in lucem prode\bold{<lb/>} \\
re cupio, ſi fieri poterit, antequam ad directionem mei Horoſcopi cum corpore\bold{<lb/>} \\
Martis An&ae;ret&ae; perueniam, qu&ae; quidem directio circa annum milleſimum\lwr quin-\bold{<lb/>} \\
...
\vspace{3mm}
\begin{mainrule}
Rule 2: Within table cells, if text is broken into separate lines, use \xms{lb} to mark the line break.
\end{mainrule}
...
\begin{typeLatin}
\bold{<table>} \\
\bold{<head>}Tabula ad inueniendam qualitatem \bold{<lb/>} \\
Auri, ex grauitate quam ha- \bold{<lb/>} \\
bet in aere &amp; aqua.\bold{</head>}  \\
\bold{<row><cell>}Qualitas \bold{<lb/>} Auri. \bold{</cell><cell cols="4">} Grauitas Auri \bold{<lb/>}\lwr in aere. \bold{</cell>}\bold{<cell>} Miſt\~u ... ære.\bold{</cell></row>} \\
...
\bold{</table>} \\
\bold{<table>} \\
\bold{<head>}Tabella Partis pro \bold{<lb/>} \\
portionalis Deno- \bold{<lb/>} \\
minatorum Auri.\bold{</head>} \\
\bold{<row><cell>}Pars proportio \bold{<lb/>} nalis Auri in \bold{<lb/>} partibus. 24. \bold{</cell>}\lwr\bold{<cell cols="2">} Differ\~etia ... aqua.\bold{</cell></row>} \\
...
\begin{typeLatin}
\bold{<table>} \\
\bold{<row><cell rows="2">}Diametri \bold{<lb/>} magnitu- \bold{<lb/>} do. \bold{</cell>}\lwr\bold{<cell cols="4">} Aureæ ſpheræ \bold{<lb/>} grauitas.\bold{</cell></row>} \\
...
\begin{mainrule}
  The whole index is marked by \xmlpatt{list}{type}{index}. Enclose each entry with \xmlpair{item}.
...
\bold{<item>}Chalk, a good compoſt, \bold{<ref>}122, 123\bold{</ref>}. Good for\bold{<lb/>} \\
Paſture, as well as for Arable  \bold{<ref>}ibid\bold{</ref>}. \bold{</item>}\\
...
\bold{<item>}Diminuzione di groſſezze, come deb- \bold{<lb/>}\\
 ba condurſi. \bold{<ref>} 56 \bold{</ref></item>}\\
\bold{<item><hi rend="emph">}Diocleziano\bold{</hi>}. Sue Terme. \bold{<ref>} 51 \bold{</ref></item>} \\
\someText \\
\bold{<cb n="2"/>} \\
\someText \\
\bold{<item>}Errori di queſto genere, cagione di \bold{<lb/>}\\
 tutti gli errori. \bold{<ref>} 18. 19 \bold{</ref></item>}\\
\bold{<item>} Provvedimenti dei Romani con-\bold{<lb/>} \\
 tro a queſti errori. \bold{<ref>} 19 \bold{</ref></item>}\\
\someText \\
\bold{</list>} \\
\end{typeLatin}
\end{sampleImage}
...
\bold{<item>}Cap. 1. \bold{<space/>} De Chorographia generatim: quid ſit, &amp; que ad eam In-\bold{<lb/>}\\
 ſtrumenta poti{ſs}imùm requiſita, \bold{<ref>} pag. 1.\bold{</ref></item>} \\
...
\begin{typeLatin}
\bold{<list rend="emph" type="toc">} \\
\bold{<item><hi rend="emph">}CH\bold{<hi rend="sc">}APITRE\bold{</hi>} I.\bold{</hi>} Où l'on enſeigne comme ſe\lwr fait la pouſſée des\bold{<lb/>} \\
 Voutes, &amp; où l'on raporte quelques principes tirés de la méca-\bold{<lb/>} \\
 nique pour en faciliter l'intelligence \bold{<ref>} 2 \bold{</ref></item>}\\
\bold{<item><hi rend="emph">}C\bold{<hi rend="sc">}HAP\bold{</hi>}. II. \bold{</hi>} De la maniere de calculer\lwr l'épaiſſeur des Pié-droits \bold{<lb/>}\\
 des Voutes en plain ceintre pour eſtre en équilibre par leur ré- \bold{<lb/>}\\
 ſiſtance avec la pouſſée qu'ils ont à ſoûtenir. \bold{<ref>} 10\bold{</ref></item>}  \\
\bold{</list>} \\
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>} \someText \\
extrema ad axes \bold{<space/>} angulorum\bold{<gap/>} continent autem hunc propoſitiones \bold{<lb/>} \\
ferè exiſtentes vna multa, &amp; varia theoremata, &amp; linearum, &amp;\lwr ſuperficie- \bold{<lb/>} \\
rum, &amp; ſolidorum omnia ſimul vna demonſtratione, &amp; quæ nondum de- \bold{<lb/>} \\
monſtrata ſunt, &amp; quæ \bold{<space/>} &amp; in duodecimo libro horum elemento- \bold{<lb/>} \\
\someText \bold{</p>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
\begin{typeLatin}
\bold{<p>}
Si ad aliquã rectã lineã * compare\xent{tr} parallelogrãm\bs\tld{}u, defici\bs\tld{}es forma\bold{<lb/>} \\
\bold{<note place="margin right">}παραβληθῆ, \bold{<hi rend="emph">}ap \bold{<lb/>} \\
ponatur, appli- \bold{<lb/>} \\
cetur\bold{</hi></note>}\bold{<lb/>} \\
quadrata, ipſum cõparat\bs\tld{}u æqu\bs\tld{}u eſt ei quod (cõtine\xent{tr}) ſub ſegm\bs\tld{}etis\bold{<lb/>} \\
...
\bold{<p>}Si fuerint tres rectæ lineæ in ratione aliqua,\bold{<lb/>} \\
...
\bold{<p>}Εὰν ὦ\li{στι} τρ\li{εῖ}ς εὐθ\li{εῖ}\li{αι} \li{ἐν} λόγῳ \li{τι}νὶ, ἔ\li{σται} ὡς \bold{<lb/>} \\
ἡ \li{πρ}ώ\li{τη} \li{πρ}ὸς τ\li{ὴν} τ\li{ρί}\li{την} \li{οὕ}τως \li{τὸ} \li{ὑπὸ} τῆς\bold{<lb/>} \\
\end{typeLatin}
\end{sampleImage}
...
circumferentiam datæ rectæ A, æqualem eſſe. Cùm enim ſit, vt E,\bold{<lb/>} \\
ad A, ita B D, ad F G; hoc est, \bold{<note place="margin right" n="a">}15.\bold{<lb/>}\lwr\bold{<hi rend="emph">}quinti.\bold{</hi></note>} ita tota diameter circuli B C, ad\bold{<lb/>} \\
totam diametrum circuli F H: Sit autem vt diameter ad diametrum,\bold{<lb/>} \\
ita circumferentia B C, ad circumferentiam F H, vt Pappus demon- \bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>} \someText \\
montre que vous placeriéz en cette façon \bold{<lb/>} \\
ſur une boule.\bold{</p>} \\
\bold{<figure place="here"/>} \\
\bold{<p>}Sous cette \bold{<hi rend="emph">}cornée\bold{</hi>}, eſt \bold{<hi rend="emph">}l'iris\bold{</hi>}, autre\lwr membrane, \bold{<lb/>} \\
\someText \bold{</p>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
\bold{</figure>} \\
\bold{<p>}Præterea ſi quando miſtura ſatis plumbi non habuerit, addito cum forci \bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImageSmall}
...
\bold{<p>}Si areola comprehenſa fuerit ſub rationali &amp; apotome ſecunda\bold{<lb/>} \\
...
\bold{</figure>} \\
\bold{<p rend="emph">}\bold{<hi rend="emph">}THEON\bold{</hi>} ex \bold{<hi rend="emph">}Z\bold{</hi>}ãb.\lwr \bold{<hi rend="emph">}A\bold{</hi>}reola nãq; α β, \\
cõpreh\bs\tld{}edatur ſub ratiõali α γ, \&amp; \bold{<hi rend="emph">}2\bold{</hi>} a- \\
potome α δ. \bold{<hi rend="emph">}D\bold{</hi>}ico \xent{qd} quæ α β, areolam\\
poteſt, mediæ apotome eſt prima. \bold{<hi rend="emph">}E\bold{</hi>}ſto\\
enim (\xent{pr} 79 decimi) ipſi α δ cõgru\bs\tld{}es δ\\
\someText \bold{</p>}\\
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>}FErunt Ariſtipp\bs~u tempeſtate maris ad incognita littora delatum, cum in are-\bold{<lb/>} \\
na vidiſſet quaſdã figuras geometricas delineatas exultant\bs\tld{}e l&ae;titia\lwr dixiſſe: Hæc\bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>}LV\bold{<hi rend="sc">}MEN\bold{</hi>} Lunæ etiam ſi ſit lumen reflexum Solis ab ipſa Luna,\lwr ab ea tamen\bold{<lb/>} \\
non ita reflectitur, vt à ſuperficie polita ſpeculi, c\bs\tld{}u eius luminis tantã quã\bold{<lb/>} \\
titatem ſuper ipſum corpus lunare videamus, &amp; eo modo terminatã quo\bold{<lb/>} \\
conſpicimus. per ſe lumen, cauſa oculi eſt effectum, per accidens autem\bold{<lb/>} \\
puta quod vis. Terra deinde nunquam lunari lumine (quãuis ſolaris\lwr reflexio exiſtat)\bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{clarification}
Type \xml{add rend="handwritten"} on a separate line, after the line of the main text the note is closest to.
\end{clarification}
...
\begin{typeLatin}
\bold{<p>} \someText
h. ſupponendo igitur in puncto. g. pondus, aut virtutem mouentem unius\lwr libræ, &amp; in\bold{<lb/>} \\
h. duarum librarum, abſ\li{que} dubio hæ duæ uirtutes in huiuſmodi diſtantijs\lwr à centro\bold{<lb/>} \\
&ae;quales inuic\bs\tld{}e er\bs\tld{}ut, ob rationes prioribus capitibus iam allatas, &amp;\lwr ſtatera orizontalis\bold{<lb/>} \\
\bold{<add rend="handwritten"/>}\\
manebit. Vnde clarum erit, \xent{qd} quæuis etiam exigua virtus adiuncta ipſi.\lwr g. mouebit\bold{<lb/>} \\
...
\begin{typeLatin}
\bold{<p>} \someText
d &amp; f ad quadratum f, ergo diſiunctim erit quadratu\bold{<unclear>}m\bold{</unclear>}\lwr ad\bold{<lb/>} \\
quadratum f, ergo b ad e ſicut d ad f, item per æquam pro-\bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
...
\begin{typeLatin}
\bold{<p>} \someText
feſſore: cui acceptum feras quicquid hîc aut ad Gr&ae;cum\lwr exe\bold{<unclear>}m\bold{</unclear>}plar, aut alio-\bold{<lb/>} \\
qui doctè reſtitutum uideris. Adiecimus Phænomena, S\bold{<gap/>}ecularia, Pro-\bold{<lb/>} \\
theoriam Marini, &amp; Data, argumentorum ſimilitudine in\bold{<unclear>}d\bold{</unclear>}ucti.\lwr Quum\li{\bs´que}
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>}Exempli gratia, ſumemus quadratum. \bold{<hi rend="emph">}3\bold{</hi>}. ſcilicet 9. quod\lwr in ſummam cum qua-\bold{<lb/>} \\
drato. 4. colligemus, nempè. 1\bold{<hi rend="emph">}6\bold{</hi>}. erit\bs'q; quadratum. 25. &amp;\lwr ita quadratum. 6. hoc eſt.\bold{<lb/>} \\
\bold{<hi rend="emph">}36\bold{</hi>}. collectum cum quadrato. 8. nempè. \bold{<hi rend="emph">}6\bold{</hi>}4.\lwr efficiet quadratum. 100. ita etiam qua-\bold{<lb/>} \\
dratum. \bold{<hi rend="emph">}9\bold{</hi>}. hoc eſt. 81. coniunctum quadrato. 12. nempè. 144.\lwr producet quadra- \bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>} \someText
ſcindendus pannus uel tela: num id ſine cultro uel forfice faciet? num con-\bold{<lb/>} \\
ſuet ullam ueſtem ſine acu? ne populus quidem tranſmarinus pennarum\bold{<lb/>} \\
contextu corporis tegumentum faciet ſine &ij;ſdem inſtrumentis, nec pel-\bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{clarification}
  This applies not only to paragraphs (\sect{section paragraphs}), but also to tables (\sect{section tables}), i.e. \xml{table rend="emph"}, and pages (\sect{section page breaks}), i.e. \xms{pb rend="emph"}. %If you use §it§, do not mark the lines with additional §_ _§ to indicate italics.
...
\begin{typeLatin}
\bold{<p>} \someText\\
bus, figuris vtar geometricis, ita enim in .2. libr. fecit Euclides, qui mo-\bold{<lb/>} \\
dus, eo magis mihi arridet, quo minus eſt abſtractus, \bold{<hi rend="emph">}quoniam\lwr oportet in-\bold{<lb/>} \\
telligentem phantaſmata ſpeculari\bold{</hi>}, cum pr&ae;terea perſpicuum ſit, diſcretum\bold{<lb/>} \\
omne, ex continui diuiſione aliquo modo oriri, ſiue actu, ſiue potentia.\bold{<lb/>} \\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p>}C\bold{<hi rend="sc">}AMPANVS\bold{</hi>}. Sit datus trigonus\bold{<lb/>} \\
a: cui nos uolumus æquum quadra-\bold{<lb/>} \\
tum deſcribere. Deſignabo ſuperfici\bs\tld{}e \bold{<lb/>} \\
\someText \bold{</p>} \\
\end{typeLatin}
...
\begin{typeLatin}
\bold{<head rend="emph"><hi emph="red">}OMNES PERSPICVIS DEMONSTRA-\bold{</hi>} \bold{<lb/>} \\
tionibus, accuratiſque ſcholi&is; illuſtrati: nunc quartò editi, \bold{<lb/>} \\
ac multarum rerum acce&sz;ione post primam \bold{<lb/>} \\
editionem locupletati.\bold{</head>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
upright & \lig{ff} & \lig{fi} & \lig{fl} & \lig{ffi} & \lig{ffl} & \lig{ſſ} & \lig{ſi} & \lig{ſſi} & \lig{ſt} & \lig{ﬆ} & {\fontspec[Ligatures=Rare]{Hoefler Text} \Large ct} \\[2mm] % siehe fontspec.pdf, Abschnitt "Ligatures"
italics & \lig{\textit{ff}} & \lig{\textit{fi}} & \lig{\textit{fl}} & \lig{\textit{ffi}} & \lig{\textit{ffl}} & \lig{\textit{ſſ}} & \lig{\textit{ſi}} & \lig{\textit{ſſi}} & \lig{\textit{ſt}} & \lig{\textit{ﬆ}} & {\fontspec[Ligatures=Rare]{Hoefler Text} \Large \textit{ct}} \\[2mm] % siehe fontspec.pdf, Abschnitt "Ligatures"
...
\begin{typeGreek}
\bold{<head>}Πάππ\li{ου} τ\li{οῦ} Αλεξαν\li{δρ}έως Σ\li{υν}α\li{γω}\li{γῆ}ς \bold{<lb/>} \\
ἕβ\li{δο}\li{μο}ν.\bold{</head>} \\
\bold{<p>}Πε\li{ρι}έχ\li{ει} δὲ λήμμα\li{τα} τ\li{οῦ} ἀναλυο\li{μέν}\li{ου} \li{τό}\li{πο}υ.\bold{</p>} \\
\bold{<p>}Ο καλ\li{ού}\li{μεν}ος ἀναλυό\li{μεν}ος, Ερμόδωρε \li{τέ}κνον, \bold{<lb/>} \\
κα\li{τὰ} σύ\li{λλ}η\li{ψι}ν ἰ\li{δί}α \li{τί}ς ἐ\li{στι}ν ὕλη \li{πα}ρε\li{σκ}\li{ευ}ασ\li{μέν}η, \bold{<lb/>} \\
\li{μετὰ} τ\li{ὴν} \li{τῶν} \li{κο}ινῶν \li{στο}ιχ\li{εί}ων \li{πο}ίη\li{σι}ν, \li{το}ῖς β\li{ου}λομένοις \bold{<lb/>} \\
\someText \bold{</p>}
\end{typeGreek}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p rend="fr">}Newton hat aber noch mehr entdeckt. Er hat durch Rech- \bold{<lb/>} \\
nungen nachgewieſen, daß man genau aus der Umlaufszeit \bold{<lb/>} \\
eines Planeten beweiſen kann, wie ſtark die Anziehungskraft \bold{<lb/>} \\
der Sonne auf ihn wirkt. Iſt nämlich die Anziehungskraft \bold{<lb/>} \\
ſtark, ſo wird ſein Umlauf ſchnell ſein; iſt die Anziehungs- \bold{<lb/>} \\
kraft ſchwach, ſo wird ein Planet langſamer um die Sonne \bold{<lb/>} \\
laufen.\bold{</p>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
\begin{typeLatin}
\bold{<p rend="fr">}Der innere weſentliche Unterſchied zwiſchen elektri- \bold{<lb/>} \\
ſchen und nicht-elektriſchen Körpern gehört zu den noch \bold{<lb/>} \\
unentdeckten Geheimniſſen der Natur. Nur ſoviel iſt \bold{<lb/>} \\
ausgemacht, daß das leitende Vermögen der Körper eini- \bold{<lb/>} \\
germaßen von der Wärme abhängt, oder durch dieſelbe \bold{<lb/>} \\
verändert wird. Glas, Harz und viele andere elektrische \bold{<lb/>} \\
Körper werden durch die Hitze in Leiter verwandlet; da \bold{<lb/>} \\
hingegen die Kälte, wenn nur keine Feuchtigkeit dabey \bold{<lb/>} \\
iſt, alle elektriſche Subſtanzen noch ſtärker elektriſch \bold{<lb/>} \\
macht.\bold{</p>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
\begin{typeLatin}
\bold{<p rend="fr">}Die weil aber nitt geleich volget wann ſie geberen/ daß ſie auch\lwr einerley \bold{<lb/>} \\
thier ſeyend/ als in den roſſen vnd eſſlen beſchicht/ wöllen wir l\li{uo}gen ob die \bold{<lb/>} \\
ſo gehoren ſeind/ etwas verletzet werden/ wie die maul thier. dañ ſie werden \bold{<lb/>} \\
auß zweyerley arten geboren. Wölche aber wider geberen/ die ſeind auß ge \bold{<lb/>} \\
leicher art geboren/ als auß einem hund vnd fuchs. Wir müſſend auch die \bold{<lb/>} \\
beſondere würckungen ergründen/ als wann ein hund ein beſondere nei- \bold{<lb/>} \\
gung z\li{uo} dem menschen/ daß roß hatt ſein beſonder geſchrey/ der pfauw ri- \bold{<lb/>} \\
chtet ſein ſchwantz auff in ein ring/ der menſch iſt allein mitt vernunfft be- \bold{<lb/>} \\
gabt.\bold{</p>}
\end{typeLatin}
\end{sampleImage}
...
\begin{typeLatin}
\bold{<p rend="fr">}Das Meiſterwerk, das der Menſch mit zur Welt bringt, \bold{<lb/>} \\
iſt das \bold{<hi rend="sp">}Auge\bold{</hi>}; das Kunſtwerk, das er dem Auge ähnlich her- \bold{<lb/>} \\
vorbringt, iſt die \bold{<hi rend="sp">}Kamera-Obscura\bold{</hi>}. Wir wollen ſie nun \bold{<lb/>} \\
beide näher kennen lernen, um ſie vergleichend neben einander \bold{<lb/>} \\
ſtellen zu können.\bold{</p>}
\end{typeLatin}
\end{sampleImageSmall}
...
\begin{typeLatin}
\bold{<p rend="fr">}Blume der Wieſen-Salbei \bold{<hi rend="rom">}(Salvia \bold{<lb/>} \\
pratensis)\bold{</hi>} ſchwach vergrößert.\bold{</p>} \\
\end{typeLatin}
\end{sampleImageSmall}
...
\begin{typeLatin}
\bold{<p>} \someText
cetur AD aut DB, \bold{<hi rend="emph">}r\bold{</hi>}. BG ſit = \bold{<hi rend="emph">}x\bold{</hi>}.\lwr eritque FG\bold{<hi rend="sup">}q\bold{</hi>} = 2 \bold{<hi rend="emph">}r x\bold{</hi>} - \bold{<hi rend="emph">}x\lwr x\bold{</hi>}, unde \bold{<lb/>} \\
Cubus FG = \bold{<formula>}√\bold{\{}2 \bold{<hi rend="emph">}rx\bold{</hi>} - \bold{<hi rend="emph">}xx\bold{</hi>}\bold{\}</formula>}\lwr \bold{<g ref="\#001"/>} \bold{<formula>}√\bold{\{}2 \bold{<hi rend="emph">}rx\bold{</hi>} - \bold{<hi rend="emph">}xx\bold{</hi>}.\bold{\}}\lwr\bold{</formula>} &amp; Cubus AD = \bold{<hi rend="emph">}r\bold{</hi><hi rend="sup">}3\bold{</hi>}. qua- \bold{<lb/>}\\
re Cohærentia baſeos ADC eſt ad eam baſeos FGE uti \bold{<hi rend="emph">}r\bold{</hi>}\lwr\bold{<hi rend="sup">}3\bold{</hi>} ad \bold{<lb/>}\\
\someText \bold{</p>}
\end{typeLatin}
\end{sampleImage}
